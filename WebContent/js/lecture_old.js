		...
		switch(id){
		  ...
		  case 16:
				...
				if(isReplaceEnable){
					...
					//alert("22222::"+selGroupObj);
					if(selGroupObj != null){
						if(!checkAndPopulateSelObjArray()){
							alert("Group is not editable in text editor");
						}
					}
			...
			if(isEditTimerEnable){
				...
				if(pos != -1){
					...
					if(groupObj!= null && groupObj.refObjectList != null){
						...
						//console.log("groupObj.active::::"+groupObj.active);
						selGroupObj = groupObj;
						if(groupObj.active){
		  ...
		  if(selObjArray!= null){
			  for(var i=0;i<selObjArray.length;i++){
				...
				var pointsArr = graphicsObject.pointsArray;
					...
					drawObject(objectTable,selObjArray[i],false);
					//console.log("selGroupObj::::"+selGroupObj);
					if(selGroupObj!= null && selGroupObj.refObjectList != null){
						/*
						var refList = selGroupObj.refObjectList;
						for(var i=0;i<refList.length;i++){
								selObjArray[selObjArray.length] = refList[i];
