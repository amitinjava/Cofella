...
* Dated on 30/05/06
* Purpose: Creating hashtable usgin java script for maintaining key(Image Name) And value(TopicId+Quesdownloadlink)
*/
...
//console.log("222222222222222222222222222"+this.keys);
	this.hash[key] = value;
}
