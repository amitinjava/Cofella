...
<body id="full" onresize="windowResize()">
...
<div class="row-fluid" id="timeline">
    <div class="right"><span class="pull-right">14:00-27:00</span></div>
    <div class="left">
      <div class="btn-group">
      <button type="button" class="btn btn-default" id="playpause" ><i id="playpauseBut"  class="fa fa-lg fa-play"></i></button>
    ...
    <div  id="timeline_div" class="container-fluid" style=" border: 1px solid #ff0000;"><canvas id="timeline_canvas"></canvas></div>
</div>
