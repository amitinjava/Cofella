...
<div class="container">
  ...
  <div class="text-center"><img src="<%=request.getContextPath()%>/images/ilc-logo-grey.png"></div>
      ...
      <form class="form-signin" role="form" action="setpassword" method="post">
        ...
        <input type="password" class="form-control" placeholder="Password" name="pwd" required autofocus>
        <input type="password" class="form-control" placeholder="Confirm Password" name="confPwd" required>
