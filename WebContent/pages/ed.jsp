...
menu.small .recording:hover:before {
   background: rgba(250, 6, 36, 0.8);
}
...
<body ng-controller="RecorderController"  onresize="windowResize()">
    ...
    <div id = "meetingDiv" style="position:absolute;top:150px;left:300px;width:390px;height:265px;z-index:1;border:1px solid;background-color:#CCCCCA;display:none;">
		<div align="center">
			...
			<!--
			<button type="button" class="btn btn-default" onclick="underLineSelectedText();" >
				<a href="#toolOptions" class="switchContent" data-toggle="tooltip" data-placement="bottom" title="Underline">
		...
		<div align="right">
			...
			<!--<input type="button" value="setPlayerTime" onclick = "setPlayerTime()"  />-->
		...
		<div id="toolMenu" class="well well-sm" style="display:none">
			...
			<div class="btn-group options">
				...
				<button type="button" id ="zoom" class="btn btn-default" disabled onclick="setId(15,true)"><a href="#zoomOptions" class="switchContent"  data-toggle="tooltip" data-placement="bottom" title="Zoom Tool"><i class="fa fa-search fa-lg"></i></a></button>
				...
				<button id="closedShapeButton" type="button" class="btn btn-default" onclick = "checkAndSetId(this)">

					<span class="dropdown table-menu">
                        <a data-toggle="dropdown" href="#"><i id="closedShape" class="fa fa-square-o fa-lg" data-toggle="tooltip" data-placement="bottom" title="Closed Shape Tool"></i><span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="tools">
	                        <li>
						        <a href="#toolOptions" onclick = "setId(1,true)" class="switchContent"><i class="fa fa-square-o fa-lg"></i>Square</a>
						        <a href="#toolOptions" onclick = "setId(1,true)" class="switchContent"><i class="fa fa-square-o fa-lg"></i>Rectangle</a>
						        <a href="#toolOptions" onclick = "setId(2,true)" class="switchContent"><i class="fa fa-circle-o fa-lg"></i>Oval</a>
						        <a href="#toolOptions" onclick = "setId(12,true)" class="switchContent"><i class="fa fa-circle-o fa-lg"></i>Circle</a>
						        <a href="#toolOptions" onclick = "setId(5,true)" class="switchContent"><i class="fa fa-caret-up fa-lg"></i>Triangle (free form)</a>
						        <a href="#toolOptions" onclick = "setId(5,true)" class="switchContent"><i class="fa fa-caret-up fa-lg"></i>Triangele (right)</a>
						        <a href="#toolOptions" onclick = "setId(13,true)" class="switchContent"><i class="fa fa-caret-up fa-lg"></i>Triangle (equilateral)</a>
						     </li>
                        </ul>
                    </span>
				</button>
				
				<button id="openShapeButton" type="button" class="btn btn-default" onclick = "checkAndSetId(this)">
					<span class="dropdown table-menu">
                        <a data-toggle="dropdown" href="#"><i id="openShape" class="fa fa-minus fa-lg" data-toggle="tooltip" data-placement="bottom" title="Open Shape Tool"></i><span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="tools">
	                        <li>
						        <a href="#toolOptions" onclick = "setId(3,true)" class="switchContent"><i class="fa fa-minus fa-lg"></i>Line</a>
						        <a href="#toolOptions" onclick = "setId(6,true)" class="switchContent"><i class="fa fa-long-arrow-right fa-lg"></i>Arrow</a>
						         <a href="#toolOptions" onclick = "setId(11,true)" class="switchContent"><i class="fa fa-circle-o-notch fa-lg"></i>Arc</a>
						    </li>
                        </ul>
                    </span>
				</button>
			...
			<!--	<button id="docButton" type="button" class="btn btn-default" >
					<span class="dropdown table-menu">
                        <a id="docDropDown" data-toggle="dropdown" href="#"><i id="fileSelected" class="fa fa-file-text-o fa-lg" data-toggle="tooltip" data-placement="bottom" title="Documents"></i><span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu" aria-labelledby="tools">
	                        <li>
				...
				<button id="editorButton" type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Text Editor" onclick = "setId(16,true)" ><i class="fa fa-font fa-lg"></i></button>
...
<!-- TOOL OPTIONS TARGET AREA /\/\\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ -->
				...
				<!-- OPTIONS FOR SELECT TOOL --><span id="toolOptions1" style="display:none">
					...
					<button id="playFrObjButton" type="button" class="btn btn-default" disabled onclick="playfromObject();" ><a href="javascript:void(0)" class="switchContent"  data-toggle="tooltip" data-placement="bottom" title="Play from Selected Object" ><i class="fa fa-caret-square-o-right fa-lg"></i></a></button>
					<button type="button" class="btn btn-default" onclick="selectedFile('video');" ><a href="javascript:void(0)" class="switchContent"  data-toggle="tooltip" data-placement="bottom" title="Upload Video/Audio" ><i class="fa fa-video-camera fa-lg"></i></a></button>
...
function setId(id,state){
		...
		switch(id){
		  ...
		  case 2:
				...
				prevSelButtonObj = obj;
				prevSelCloseShapeId = id;
				document.getElementById("closedShape").className = "fa fa-circle-o fa-lg";
				isSetIdCalled = state;
			break;
		  case 3:
		  ...
		  case 6:
				...
				prevSelButtonObj = obj;
				prevSelOpenShapeId = id;
				document.getElementById("openShape").className = "fa fa-long-arrow-right fa-lg";
				isSetIdCalled = state;
		  break;
		  case 7:
		  ...
		  case 11:
				...
				prevSelButtonObj = obj;
				prevSelOpenShapeId = id;
				document.getElementById("openShape").className = "fa fa-circle-o-notch fa-lg";
				isSetIdCalled = state;
		  break;
		  case 12:
		 		var obj = document.getElementById("closedShapeButton");
		  ...
		  case 13:
				...
				prevSelButtonObj = obj;
				prevSelCloseShapeId = id;
				document.getElementById("closedShape").className = "fa fa-caret-up fa-lg";
				isSetIdCalled = state;
		  break;
		  case 16:
		...
		if(isDrawing){
			...
			if(currentObjId != 7 ){
				...
				if(currentObjId != 16){
					...
					//console.log("Before count::::"+count+"::objectTable:::"+objectTable.get(count));
					objectTable.put(count, graphicsObject);
					//console.log("Afetr count::::"+count+"::objectTable:::"+objectTable);
					objectPageRefTable.put(count,pageNum);
				}
				if(isReplaceEnable){
	...
	if (isDrawing) {
		...
		if(currentObjId == 7){
			...
			if(dragFlag){
				...
				if(selObjArray != null && selObjArray.length>0 && !isZoomEnable){
...
function drawObject(objectTable,id,highlight){
	...
	*/
	...
	//console.log("drawObject:::graphicsObject:;"+graphicsObject);
	ctx.beginPath();
	if(highlight == 'sel'){
		//ctx.lineWidth= 2;
		//ctx.setLineDash([3]);
...
//console.log("Inside init:::"+currentObjId);
	// if(rectangleSelObject != null)
	 if(selObjArray != null && selObjArray.length>0 && !(isRotaionEnable || currentObjId == 15) ){
...
function createJSON(){
		...
		if(filename != null && filename.length >0 ){
			...
			var data = data + ', "TempRecFile":"'+ filename +'","RecFname":"'+recFileName+'.mp3"'+',"RecFileDuration":"'+recFileDuration+'"';
		}
...
function setplayingTimeInPlayer(){
  ...
  document.getElementById("cTime").innerHTML = "<b>"+min + ":"+sec+"</b>";
  //console.log("min::"+min+"::sec::"+sec);
  setTimeout('setplayingTimeInPlayer()',500);
}
