...
var Path = PathItem.extend({
	...
	setSegments: function(segments) {
		...
		this._curves = undefined;
		if (segments && segments.length > 0){
			console.log("@@@@@"+this._add(Segment.readAll(segments)));
		}
		//alert("1111");
		if (fullySelected)
	...
	console.log("_add::::;"+segs+":::index::"+index);
		var segments = this._segments,
			curves = this._curves,
			amount = segs.length,
			append = index == null,
	...
	//console.log("tolerance::;"+tolerance+":::"+this._segments.length);
		if (this._segments.length > 2) {
			var fitter = new PathFitter(this, tolerance || 2.5);
			console.log("fitter::"+fitter.fit());
	...
	console.log("drawSegments------"+path._segments);
		var segments = path._segments,
...
var PathFitter = Base.extend({
	initialize: function(path, error) {
		...
		var segments = path._segments,
			prev;
			//console.log("PathFitter::"+segments);
		for (var i = 0, l = segments.length; i < l; i++) {
